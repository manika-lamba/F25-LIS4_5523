...
::: notes
Let's do a quick exercise. There are no wrong answers here!

So, first try to use the word "tear" in a short sentence.

Were you thinking, about (i) tearing a piece of paper or (ii) tears coming down from eyes.

Okay, let's go on to the next question: Use ONLY ONE word to describe the picture on the slide.

Were you thinking: globe, world, planet, space, or earth??
:::
