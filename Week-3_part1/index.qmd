---
title: "Information Systems, Databases & Representations"
...
::: notes
To be an efficient and effective searcher of online systems, as well as to be
able to teach others to search, it is essential that you understand how systems
are developed, structured, and searchable. Also of importance is knowing
about how the representations for the items in the system are developed, the
rules that are used by the indexer or cataloger, and how their decisions affect
retrieval. 

This lecture introduces you first to information systems and how they
work to effect retrieval within a database environment. Secondly we will learn
about how databases are developed through the data modeling process, as well
as the decisions the developer makes when setting up a system. Third, we will
connect the database structure to how a system searches. Lastly we will take a
closer look at some systems we know and discuss how they are structured.

In the second lecture, we will look at how indexers create database
records and the process of subject analysis. Understanding how terms are
chosen by indexers/catalogers will help you choose appropriate terms for your
searches and how to use a system’s features to improve your searches.
:::
...
these are different kinds of information systems. You use information systems every day to find information, to make online
purchases, at work, or in many different contexts.
:::
...
virtual, electronic, digitized, print–doesn’t matter. 
...
or a set of purposes. When
searching for information you will use many different systems, such as bibliographic
systems or specialized databases, library catalogs (OPACs), multimedia databases, etc.
Chowdhury, Ch. 2 talks more about the various types of systems you may use.
...
Of course the records in the
systems we use are more complex than this example but this basic records illustrates
the basic fields in most records in libraries and online databases which describe
bibliographic entities such as books or journal articles.
:::
...
::: notes
How is this related to information retrieval or to searching? The organization of records within a file is really the key
...
## What about Searching and Representation?

- Knowing more about how a database is structured can aid in searching
- Understanding how indexes and indexing works can make you a more efficient searcher

:::notes
So, why is this important to searching? Knowing more about how a database is
structured can aid you in searching. It can help you become a more efficient searcher.
It can help you understand what happens when you get results back that don’t make
sense, and then you can also explain false drops and irrelevant results back to your
users.

Understanding how indexes and indexing works can also make you a more efficient
searcher if you understand how a system is interacting with your query and how it
matches the terms within the database records; also, how it’s matching inverted
indexes for specific fields, rather than doing a full text search of a text field in the
document.

Throughout the semester you will learn some advanced search techniques that use the inverted indexes of the system (by using the fielded search) AND about the kinds of searching we conduct (such as Controlled Vocabulary searching, Free text/Full-text searching).
:::

## Going Forward

- In Module 2, we will examine different systems and how they are designed 
...
- We will also look at the concept of representation in Module 2.2 as it relates to subject indexing in online retrieval systems

:::notes
So, in this module, you’re going to be examining some different systems and how
they’re designed. You’ll be looking at a variety of systems, and then using the systems
evaluate them from a user’s perspective.

You also are going to be learning more about how system design affects and impacts
retrieval by the users. So, you can think back about what we’ve just talked about
regarding inverted indexes and how those choices we make when we’re setting up a
database can actually impact the search and retrieval of the users. Think about how
word indexing works and how phrase indexing works and the inverted file that gets
created as a result of the choices we’ve made. And then when we create new records,
the terms that we enter within those records go into that index. So, again, you’re going
to be thinking and learning more about how system design impacts or affects the
retrieval of users.

I also want you to think about how systems’ elements, or the different aspects within
the system, the different features, and the metadata schemes and the different
interfaces either enable or inhibit effective retrieval. And think about how those
different elements all work together to achieve a specific goal or purpose.
:::